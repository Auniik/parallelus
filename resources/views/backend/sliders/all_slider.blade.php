    ...
    @foreach($sliders as $slider)
        <tr>
            ...
            <td>
                ...
                @endif
                <a class="btn btn-sm btn-primary" href="{{url('/slider/'.$slider->id.'/edit')}}"><i class="fa fa-edit fa-fw"></i></a>
                <a class="btn btn-sm btn-danger" id="delete" href="{{url('/slider/'.$slider->id.'/delete')}}" onclick="return confirmDelete();"><i class="fa fa-trash-o fa-fw"></i></a>
            </td>
        </tr>
    @endforeach
    </tbody>
